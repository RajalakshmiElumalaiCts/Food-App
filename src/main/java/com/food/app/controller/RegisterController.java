...
import com.food.app.util.StringResponse;
...
public class RegisterController {
	...
	public  ResponseEntity<StringResponse> registerUser(@RequestBody User user) {
		  ...
		  try {
			 ...
			 LOGGER.info("New user added to USER table :"+ user);
			  ...
			  return ResponseEntity.status(HttpStatus.EXPECTATION_FAILED)
					  .body(new StringResponse("Registration Unsuccess " + user.getFirstname() +" !!!"));
		  }
		  
		  return ResponseEntity.ok()
				  .body(new StringResponse("Registration success " + user.getFirstname() +"!!! "));
